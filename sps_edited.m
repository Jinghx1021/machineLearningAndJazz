function [y,yh,ys] = sps_edited(x,fs,w,N,t,maxnS,stocf,fscale)
...
% M=1001;%window size
% w=blackman(M);%analysis window (odd size)
% N= 2048;%FFT size (minimum 512)
% t=-113;%threshold in negative dB
% maxnS=20; %maximum number of sinusoids
% stocf=16; %decimation factor of mag spectrum for stochastic analysis
%%
